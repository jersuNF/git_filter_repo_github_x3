...
#define GPS_UBX_RXM_PMREQ_FLAGS_BACKUP_MASK                                                        \
	0x2 //!< Mask for field awake in bitmask flags. means not in backup mode (incative state)
...
typedef struct {
	...
	CH vendorString
		[32]; //!< String containing the vendor name. 32 ASCII bytes including 0-termination.
	CH productString
		[32]; //!< String containing the product name. 32 ASCII bytes including 0-termination.
	CH serialNumber
		[32]; //!< String containing the serial number.  32 ASCII bytes including 0-termination.
} GPS_UBX_CFG_USB_t;
...
#define GPS_UBX_MON_RXR_FLAGS_AWAKE_MASK                                                           \
	0x1 //!< Mask for field awake in bitmask flags. means not in backup mode (incative state)
