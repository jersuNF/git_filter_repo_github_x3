 ...
 *
 *  Credit:  https://github.com/cmcqueen/cobs-c
 ****************************************************************************/
 ...
 *                 dst_buf_ptr)
 */
cobs_encode_result cobs_encode(void *dst_buf_ptr, size_t dst_buf_len, const void *src_ptr,
			       size_t src_len);
 ...
 *                 dst_buf_ptr)
 */
cobs_decode_result cobs_decode(void *dst_buf_ptr, size_t dst_buf_len, const void *src_ptr,
			       size_t src_len);
